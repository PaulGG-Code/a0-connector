...
def _load_dxcam_module() -> Any:
    try:
        ...
        raise WindowsComputerUseError(
            ...
            "dxcam is required for Windows computer-use capture. Reinstall the AJ CLI Windows dependencies in the active virtual environment.",
        ) from exc
    return dxcam
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            raise WindowsComputerUseError(
                "COMPUTER_USE_UNSUPPORTED",
                (
                    "pywinauto UIA desktop automation could not initialize. Run the AJ CLI "
        ...
        try:  # pragma: no cover - only exercised on Windows
            ...
            raise WindowsComputerUseError(
                ...
                (
                    ...
                    "desktop session is unlocked and the AJ CLI is not running as a service "
        ...
        if camera is None:
            raise WindowsComputerUseError(
                ...
                (
                    ...
                    "desktop is unlocked and visible to the same user session running AJ CLI."
                ),
            )
    ...
    def uia_roots(self) -> list[Any]:  # pragma: no cover - only exercised on Windows
        try:
            ...
            raise WindowsComputerUseError(
                ...
                (
                    "Windows UI Automation roots are unavailable. Make sure the AJ CLI "
