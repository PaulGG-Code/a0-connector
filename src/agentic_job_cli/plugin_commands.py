...
from agentic_job_cli.screens.installed_plugins import InstalledPluginEntry, InstalledPluginsScreen
...
async def cmd_plugins(app: AgentZeroCLI) -> None:
    ...
    async def _toggle(
        ...
        app._show_notice(f"{entry.title} {state}. Agentic Job may reload plugin state.")
