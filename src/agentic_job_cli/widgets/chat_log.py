...
from agentic_job_cli.icon_text import normalize_icon_text
from agentic_job_cli.media_refs import ImageReference
from agentic_job_cli.widgets.image_entry import ImageEntry
from agentic_job_cli.widgets.shimmer import build_dim_status, build_shimmer_text
...
██║  ██║ ╚██████╔╝███████╗██║ ╚████║   ██║      ███████╗███████╗██║  ██║╚██████╔╝
╚═╝  ╚═╝  ╚═════╝ ╚══════╝╚═╝  ╚═══╝   ╚═╝      ╚══════╝╚══════╝╚═╝  ╚═╝ ╚═════╝"""
_AGENT_ZERO_BANNER_COMPACT = "Agentic Job"
_AGENT_ZERO_BANNER_TINY = "AJ"
...
class AgentZeroBanner(Static):
    """Responsive Agentic Job banner that keeps a readable shape while resizing."""
...
class ChatLog(VerticalScroll):
    ...
    def ensure_intro_banner(self) -> None:
        """Mount the Agentic Job intro banner above the first rendered message."""
...
def build_agent_zero_banner_widget(*, id: str | None = None, classes: str = "agent-zero-banner") -> Static:
    """Build the shared Agentic Job banner used by splash and chat views."""
