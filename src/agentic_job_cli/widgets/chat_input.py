...
from agentic_job_cli.attachments import AttachmentRef, attachment_label


_PLACEHOLDER = "Type a message... (/help for commands)"
_PROGRESS_CLASS = "progress-active"
# Same prefix as Agentic Job WebUI composer (see webui/components/chat/input/input-store.js).
_PROGRESS_PREFIX = "|>  "
