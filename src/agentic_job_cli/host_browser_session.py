...
from agentic_job_cli.host_browser_cdp import CDPConnection, CDPContext, CDPPage
...
class HostBrowserSession:
    ...
    async def _ensure_content_helper(self, page: Any) -> None:
        ...
        if self._content_helper_source is None:
            raise RuntimeError(
                "Host browser content helper source was not provided by Agentic Job Browser plugin."
            )
